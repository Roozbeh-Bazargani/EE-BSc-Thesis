function [A_star_time, Greedy_best_time, BFS_time, Q_time] = Heuristic_time(loc, iterations)
A_star_time = 0;
Greedy_best_time = 0;
BFS_time = 0;
Q_time = 0;
